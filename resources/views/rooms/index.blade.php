...
<div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
    ...
    <div class="room-card"
        ...
        <div class="flex border-t border-gray-100 divide-x divide-x-reverse divide-gray-100">
            @can('rooms.edit')
...
<div x-show="bulkPriceModal" x-cloak
    ...
    <div x-transition:enter="transition ease-out duration-200"
        ...
        <form method="POST" action="{{ route('rooms.bulkPrice') }}" class="p-6 space-y-5">
            ...
            {{-- التطبيق بالنوع فقط — لا تحديد يدوي للغرف تفادياً للخطأ --}}
                <div>
...
<div x-show="modalOpen" x-cloak
    ...
    <div x-transition:enter="transition ease-out duration-200"
        ...
        <div class="p-5 space-y-4">
            ...
            {{-- غرفة مشغولة بنزيل: لا يُسمح بتغيير حالتها إلا بتسجيل خروج النزيل --}}
            <div x-show="selectedRoom.status === 'occupied'" x-cloak
                 class="rounded-xl p-3 bg-red-50 border border-red-200 flex items-start gap-2 text-sm text-red-800">
                <svg class="w-5 h-5 flex-shrink-0 mt-0.5 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                <span>الغرفة مشغولة بنزيل — لا يمكن تغيير حالتها إلا بتسجيل خروج النزيل.</span>
            </div>
...
function roomsPage() {
    return {
        ...
        // التوحيد يتم بالنوع فقط (لا تحديد يدوي للغرف)
