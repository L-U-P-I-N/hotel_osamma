...
<div x-data="{ sidebarOpen: true }" class="flex h-screen overflow-hidden">
    ...
    <aside :class="sidebarOpen ? 'w-64' : 'w-0 overflow-hidden'" class="flex-shrink-0 bg-primary-800 text-white flex flex-col transition-all duration-300">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            @can('shifts.view')
            <a href="{{ route('shifts.index') }}" class="sidebar-link {{ request()->routeIs('shifts.*') ? 'active' : 'text-primary-200' }}">
            ...
            @can('pricing.manage')
            <a href="{{ route('pricing.index') }}" class="sidebar-link {{ request()->routeIs('pricing.*') ? 'active' : 'text-primary-200' }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5a1.99 1.99 0 011.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"/></svg>
                إعدادات التسعير
            </a>
            @endcan
