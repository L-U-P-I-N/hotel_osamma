    ...
    return {
        ...
        calcTotal() {
            if (this.checkInDate && this.checkOutDate) {
                ...
                const fn = (this.firstNightPrice !== null && this.firstNightPrice !== '')
                    ? (parseFloat(this.firstNightPrice) || 0)
                    : perNight;
                this.totalAmount = this.selectedRoom ? fn + Math.max(0, days - 1) * perNight : 0;
                this.saveToSession();
            }
        },
