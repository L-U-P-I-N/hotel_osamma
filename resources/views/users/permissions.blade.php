...
$crudGroups = [
    ...
    [
        ...
        'delete' => null,
        'extra'  => [
            'guests.sensitive'  => 'البيانات الحساسة',
            'companions.manage' => 'المرافقون',
        ],
    ],
    [
        'icon'   => '🛏️',
    ...
    [
        ...
        'delete' => null,
        'extra'  => [
            'payments.bank_receipt' => 'سندات التحويل',
            'extra_charges.manage'  => 'رسوم إضافية',
    ...
    [
        ...
        'delete' => null,
        'extra'  => [
            'shifts.reopen'     => 'إعادة فتح إقفال',
            'settlement.manage' => 'إدارة التسوية',
            'settlement.lock'   => 'إقفال التسوية',
        ],
    ],
    [
        'icon'   => '📊',
