...
if (!function_exists('ar_pdf')) {
    function ar_pdf(?string $text): string
    {
        ...
        // ar-php يحوّل أي علامة ترقيم خارج ASCII والعربية إلى تنوين فتح "ً"،
        // فتظهر الشرطة الطويلة والنقطة الفاصلة والقوسان المزدوجان كرمز غريب في
        // كل تصدير. نستبدلها بمكافئها الآمن قبل التحويل لأشكال العرض.
        $text = strtr($text, [
            '—' => '-',  '–' => '-',  '‑' => '-',  '−' => '-',
            '·' => '-',  '•' => '-',  '…' => '...',
            '«' => '"',  '»' => '"',  '“' => '"',  '”' => '"',
        ...
        // الأرقام العربية-الهندية (٠-٩) تلقى المصير نفسه: النزيل أو الموظف قد
        // يكتبها في ملاحظة أو وصف رسم، فتختفي من الفاتورة. نوحّدها أرقاماً لاتينية
        // مثل بقية أرقام النظام.
        $text = strtr($text, [
            '٠' => '0', '١' => '1', '٢' => '2', '٣' => '3', '٤' => '4',
            '٥' => '5', '٦' => '6', '٧' => '7', '٨' => '8', '٩' => '9',
            '۰' => '0', '۱' => '1', '۲' => '2', '۳' => '3', '۴' => '4',
